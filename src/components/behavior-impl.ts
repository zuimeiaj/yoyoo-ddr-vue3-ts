...
import { getBoundingRect, getHandler, getPoints, getSize, handlerPointMap, heightMap, pointMap, pointMap2, rad2deg, tr2bl, widthMap } from './util';
export default class BehaviorImpl {
  ...
  allowTransform(rect: ElementRect) {
    ...
    return rect.left >= 0 && rect.right <= localPoint.value.parentRect.width && rect.top >= 0 && rect.bottom <= localPoint.value.parentRect.height;
  }
